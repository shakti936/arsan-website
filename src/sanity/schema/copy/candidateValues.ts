...
// Shape mirrors the "candidateValues" namespace in messages/en.json.
...
export const copyCandidateValues = defineType({
  name: "copyCandidateValues",
  ...
  preview: { prepare: () => ({ title: "Candidate values" }) },
});
