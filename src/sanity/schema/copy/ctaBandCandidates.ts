...
// Shape mirrors the "ctaBandCandidates" namespace in messages/en.json.
...
export const copyCtaBandCandidates = defineType({
  name: "copyCtaBandCandidates",
  title: "“Let’s talk” band — candidates",
  type: "document",
  fields: [
    defineField({
      name: "namespace",
      ...
      hidden: true,
      readOnly: true,
      initialValue: "ctaBandCandidates",
    }),
    defineField({
  ...
  preview: { prepare: () => ({ title: "“Let’s talk” band — candidates" }) },
});
