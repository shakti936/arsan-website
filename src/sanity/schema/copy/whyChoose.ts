...
// Shape mirrors the "whyChoose" namespace in messages/en.json.
...
export const copyWhyChoose = defineType({
  name: "copyWhyChoose",
  title: "Why choose ARSAN",
  type: "document",
  fields: [
    defineField({
      name: "namespace",
  ...
  preview: { prepare: () => ({ title: "Why choose ARSAN" }) },
});
