...
// Shape mirrors the "subpage.talentNetwork" namespace in messages/en.json.
...
export const copySubpageTalentNetwork = defineType({
  name: "copySubpageTalentNetwork",
  ...
  fields: [
    defineField({
      ...
      hidden: true,
      readOnly: true,
      initialValue: "subpage.talentNetwork",
    }),
    defineField({
  ...
  preview: { prepare: () => ({ title: "Talent Network" }) },
});
