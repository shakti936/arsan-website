...
// Shape mirrors the "subpage.executiveSearch" namespace in messages/en.json.
...
export const copySubpageExecutiveSearch = defineType({
  name: "copySubpageExecutiveSearch",
  ...
  fields: [
    defineField({
      ...
      hidden: true,
      readOnly: true,
      initialValue: "subpage.executiveSearch",
    }),
    defineField({
  ...
  preview: { prepare: () => ({ title: "Executive Search" }) },
});
