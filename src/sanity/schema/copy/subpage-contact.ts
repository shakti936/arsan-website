...
// Shape mirrors the "subpage.contact" namespace in messages/en.json.
...
const shape = [
  ...
  defineField({
    name: "heroCta",
    title: "Button at the top of the page",
    type: "string",
  }),
  defineField({ name: "cta", title: "Button", type: "string" }),
];

export const copySubpageContact = defineType({
  name: "copySubpageContact",
  title: "Contact",
  type: "document",
  fields: [
    defineField({
