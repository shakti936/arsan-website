...
// Shape mirrors the "mexicoEarly" namespace in messages/en.json.
...
export const copyMexicoEarly = defineType({
  name: "copyMexicoEarly",
  title: "Mexico early",
  type: "document",
  fields: [
    defineField({
  ...
  preview: { prepare: () => ({ title: "Mexico early" }) },
});
