...
// Shape mirrors the "ctaBand" namespace in messages/en.json.
...
export const copyCtaBand = defineType({
  name: "copyCtaBand",
  title: "“Let’s talk” band — default",
  type: "document",
  fields: [
    defineField({
      name: "namespace",
  ...
  preview: { prepare: () => ({ title: "“Let’s talk” band — default" }) },
});
