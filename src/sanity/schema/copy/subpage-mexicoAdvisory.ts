...
// Shape mirrors the "subpage.mexicoAdvisory" namespace in messages/en.json.
...
export const copySubpageMexicoAdvisory = defineType({
  name: "copySubpageMexicoAdvisory",
  ...
  fields: [
    defineField({
      ...
      hidden: true,
      readOnly: true,
      initialValue: "subpage.mexicoAdvisory",
    }),
    defineField({
  ...
  preview: { prepare: () => ({ title: "Mexico Advisory" }) },
});
