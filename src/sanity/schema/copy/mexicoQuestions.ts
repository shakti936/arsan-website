...
// Shape mirrors the "mexicoQuestions" namespace in messages/en.json.
...
export const copyMexicoQuestions = defineType({
  name: "copyMexicoQuestions",
  title: "Mexico questions",
  type: "document",
  fields: [
    defineField({
      name: "namespace",
  ...
  preview: { prepare: () => ({ title: "Mexico questions" }) },
});
