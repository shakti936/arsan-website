...
export const theNewManufacturingLeader: Article = {
  ...
  en: {
    ...
    metaDescription:
      "Manufacturing leadership has changed. Five traits that separate high-performing plant and operations leaders — and how to interview for them rather than hope for them.",
    imageAlt:
      "Four manufacturing leaders standing in conversation on a working plant floor.",

    lede: [
      "The manufacturing sector is in a new era — one defined by rapid technological change, supply-chain volatility and an urgent need for operational excellence. In that environment, leadership is the difference between a plant that absorbs disruption and one that is defined by it.",
      "Today's manufacturing leaders are more than operators. They are strategists, talent developers, change agents and culture stewards. Based on our work placing and advising leaders across North America, five traits consistently separate the ones who perform.",
    ...
    takeaways: [
      {
        icon: "star",
        title: "Leadership Is the Competitive Advantage",
        body: "The right leaders align strategy, people and operations to drive sustainable performance.",
      },
      {
        icon: "target",
        title: "Five Traits Define Top Leaders",
        body: "Vision, operational excellence, people focus, agility and collaboration set high performers apart.",
      },
      {
        icon: "chart",
        title: "Interview for Them Deliberately",
        body: "Traits only count if the process detects them. Build the evidence question before the shortlist.",
      },
    ],
    ...
    asideItems: [
      "Which of these five traits does our current interview loop actually test for?",
      "For our last three senior hires, which trait turned out to be the gap?",
      "Who on our bench is two years from a plant leadership role, and who is developing them?",
    ],
  },
  ...
  es: {
    ...
    metaDescription:
      "El liderazgo en manufactura cambió. Cinco rasgos que distinguen a los líderes de planta y operaciones de alto desempeño — y cómo entrevistarlos con evidencia, no con impresiones.",
    imageAlt:
      "Cuatro líderes de manufactura conversando en el piso de producción de una planta en operación.",

    lede: [
      "La manufactura vive una nueva etapa, definida por el cambio tecnológico acelerado, la volatilidad en la cadena de suministro y una exigencia urgente de excelencia operativa. En ese entorno, el liderazgo es la diferencia entre una planta que absorbe la disrupción y una que queda definida por ella.",
      "Los líderes de manufactura de hoy son más que operadores. Son estrategas, formadores de talento, agentes de cambio y responsables de la cultura. A partir de nuestro trabajo colocando y asesorando líderes en Norteamérica, cinco rasgos distinguen consistentemente a quienes rinden.",
    ...
    takeaways: [
      {
        icon: "star",
        title: "El liderazgo es la ventaja competitiva",
        body: "Los líderes correctos alinean estrategia, gente y operación para sostener el desempeño.",
      },
      {
        icon: "target",
        title: "Cinco rasgos definen a los mejores",
        body: "Visión, excelencia operativa, foco en las personas, agilidad y colaboración distinguen al alto desempeño.",
      },
      {
        icon: "chart",
        title: "Evalúelos deliberadamente",
        body: "Los rasgos solo cuentan si el proceso los detecta. Diseñe la pregunta de evidencia antes de la terna.",
      },
    ],
    ...
    asideItems: [
      "¿Cuáles de estos cinco rasgos evalúa realmente nuestro proceso de entrevista?",
      "En nuestras últimas tres contrataciones senior, ¿qué rasgo resultó ser la brecha?",
      "¿Quién en nuestro banco está a dos años de dirigir una planta y quién lo está desarrollando?",
    ],
  },
};
