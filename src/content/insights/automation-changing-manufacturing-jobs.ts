...
export const automationChangingManufacturingJobs: Article = {
  ...
  en: {
    ...
    metaDescription:
      "Automation is changing manufacturing roles, not eliminating them. The skills, new roles and workforce planning manufacturers need to stay ahead of their own automation roadmap.",
    imageAlt:
      "A line of robotic arms working along an automated assembly cell inside a bright plant.",

    lede: [
      "Automation is reshaping manufacturing at an unprecedented pace. From AI-powered quality inspection to autonomous material handling, technology is transforming how work gets done — and who does it.",
      "The good news: automation isn't eliminating jobs; it's changing them. The manufacturers that win won't be those that automate the fastest, but those that empower their people to adapt, grow and lead in an increasingly digital world.",
    ...
    takeaways: [
      {
        icon: "users",
        title: "Invest in People, Build Advantage",
        body: "Upskilling unlocks capacity you already have, strengthens retention and shortens the time it takes to run new equipment well.",
      },
      {
        icon: "target",
        title: "Align Talent Strategy with Technology",
        body: "Put the workforce plan on the same three-to-five-year clock as the capital plan, so the roles exist before the line does.",
      },
      {
        icon: "factory",
        title: "Design the Future of Work",
        body: "Build human and machine workflows that let people intervene, improve and lead — not simply watch.",
      },
    ],
    ...
    asideItems: [
      "Which roles does our automation roadmap create in the next 24 months, and who owns hiring them?",
      "Which of those could be filled internally, with a training path we could publish this quarter?",
      "Are our job descriptions written for the process we run today, or the one we ran five years ago?",
    ],
  },
  ...
  es: {
    ...
    metaDescription:
      "La automatización no elimina puestos: los transforma. Las habilidades, los nuevos roles y la planeación de personal que los fabricantes necesitan para ir por delante de su propia hoja de ruta tecnológica.",
    imageAlt:
      "Una línea de brazos robóticos trabajando en una celda de ensamble automatizada dentro de una planta iluminada.",

    lede: [
      "La automatización está transformando la manufactura a un ritmo sin precedentes. De la inspección de calidad asistida por IA al manejo autónomo de materiales, la tecnología está cambiando cómo se hace el trabajo — y quién lo hace.",
      "La buena noticia: la automatización no está eliminando puestos; los está cambiando. Los fabricantes que ganan no serán los que automaticen más rápido, sino los que preparen a su gente para adaptarse, crecer y liderar en un entorno cada vez más digital.",
    ...
    takeaways: [
      {
        icon: "users",
        title: "Invertir en la gente es la ventaja",
        body: "La formación interna libera capacidad que ya tiene, mejora la retención y acorta el tiempo para operar bien el equipo nuevo.",
      },
      {
        icon: "target",
        title: "Alinee talento con tecnología",
        body: "Ponga el plan de personal en el mismo horizonte de tres a cinco años que el plan de inversión, para que los roles existan antes que la línea.",
      },
      {
        icon: "factory",
        title: "Diseñe el trabajo del futuro",
        body: "Construya flujos entre personas y máquinas donde la gente pueda intervenir, mejorar y liderar — no solo observar.",
      },
    ],
    ...
    asideItems: [
      "¿Qué roles crea nuestra hoja de ruta de automatización en los próximos 24 meses y quién es responsable de cubrirlos?",
      "¿Cuáles podrían cubrirse internamente, con una ruta de capacitación que pudiéramos publicar este trimestre?",
      "¿Nuestras descripciones de puesto están escritas para el proceso de hoy o para el de hace cinco años?",
    ],
  },
};
