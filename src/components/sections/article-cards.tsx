...
/** One photograph per insight, in the order the copy lists them. */
const INSIGHT_IMAGES = [
  "insight-csuite-skills",
  "insight-mexico-expansion",
  "insight-leadership-teams",
  "insight-compensation",
  "insight-hiring-mexico",
  "insight-career-move",
] as const;
            ...
            >
              <article className="flex h-full flex-col border border-cream-100 bg-white-warm shadow-[0_1px_2px_rgba(6,30,57,.06)] transition-shadow duration-300 hover:shadow-[0_10px_28px_-12px_rgba(6,30,57,.28)] motion-reduce:transition-none">
                <Plate
                  ...
                  src={`/images/${INSIGHT_IMAGES[i % INSIGHT_IMAGES.length]}.jpg`}
