...
export function NavLink({
  ...
  return (
    <Link
      ...
      className={cn(
        "relative inline-flex items-center py-2 text-sm transition-colors focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brass-300",
